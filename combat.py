...
class Combat:
    ...
    def inCombatShips(self, spaceship):
        print("\nYou engage a small group of weird looking alienships targeting you.")
        choise = input(
    ...
    def drop_rand_item(self, spaceship):
        if random.randint(0, 5) % 2 == 1:
            ...
            print(f"The alien dropped the following item: {dropped_item['name']}.")
            inp = input("Type a to pick up the item: ")
            if inp.lower() == "a":
                spaceship.inventory.append(dropped_item["name"])
                spaceship.score += dropped_item["value"]
                print(
                    f"The following item had been added to your inventory: {dropped_item['name']}."
                )
                print(
                ...
                print(
                    f"unfortunately you skipped the item worth: {dropped_item['value']} points."
                )
